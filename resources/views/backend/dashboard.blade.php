...
<head>
    ...
    <title> Bootstrap Minimal & Clean Admin</title>
    <!-- Fevicon -->
...
<body class="vertical-layout">
    ...
    <div id="containerbar">
            ...
            <div class="sidebar">
                ...
                <div class="navigationbar">
                    <ul class="vertical-menu">
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <i class="ri-pen-nib-line"></i><span>Doctors Prescriptions</span><i class="ri-arrow-right-s-line"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <i class="ri-stack-line"></i><span>Manage Doctors</span><i class="ri-arrow-right-s-line"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li>
                            <a href="javaScript:void();">
                              <i class="ri-apps-line"></i><span>Manage Users</span><i class="ri-arrow-right-s-line"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <i class="ri-todo-line"></i><span>Manage Appointments</span><i class="ri-arrow-right-s-line"></i>
                            </a>
                            <ul class="vertical-submenu">
                        ...
                        <li>
                            <a href="javaScript:void();">
                                <i class="ri-paint-line"></i><span>Manage Labs</span><i class="ri-arrow-right-s-line"></i>
                            </a>
                            <ul class="vertical-submenu">
        ...
        <div class="rightbar">
            ...
            <div class="breadcrumbbar">
                <div class="row align-items-center">
                    <div class="col-md-8 col-lg-8">
                        <h4 class="page-title">CHMS</h4>
                        <div class="breadcrumb-list">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Children Hospital Managemant System</li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="footerbar">
                <footer class="footer">
                    <p class="mb-0">© 2020 CHMS - All Rights Reserved || Developed by Faisal Afzaal.</p>
                </footer>
            </div>
            <!-- End Footerbar -->
        </div>
